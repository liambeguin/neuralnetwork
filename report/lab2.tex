...
\begin{itemize}
	\item avantages:
		...
		\subitem language interpr\'et\'e, pas de compilation
...
identiques, il est impossible d'alimenter le r\'eseau en raison des diff\'erences
de dimensions sur les produits matriciels.
D'autre part, dans le but d'am\'eliorer la vitesse de convergence de
l'apprentissage et de limiter la complexit\'e du mod\`ele, nous avons choisi de ne
...
neurones et elle est definie de la mani\`ere suivante: \\
\begin{equation}
	\begin{aligned}
